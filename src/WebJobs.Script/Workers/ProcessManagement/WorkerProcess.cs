    ...
    internal abstract class WorkerProcess : IWorkerProcess, IDisposable
    {
        ...
        public Task StartProcessAsync()
        {
            using (_metricsLogger.LatencyEvent(MetricEventNames.ProcessStart))
            {
                ...
                try
                {
                    ...
                    var hostHealthMonitor = _serviceProvider.GetHostServiceOrNull<IHostHealthMonitor>();
                    if (hostHealthMonitor != null)
                    {
                        hostHealthMonitor.Register(_process);
                    }
        ...
        private void OnProcessExited(object sender, EventArgs e)
        {
            ...
            finally
            {
                ...
                if (hostHealthMonitor != null)
                {
                    hostHealthMonitor.Unregister(_process);
                }
            }
        }
